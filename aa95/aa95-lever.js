...
<div class="panel" id="panel">
  ...
  <div class="model-brand">AA95-729</div>
  ...
  <svg class="panel-svg">
    <!-- Routing Lines pointing towards selector (center ~475, 230) -->
    <!-- COM 2 line (~8 o'clock) -->
    <polyline class="leader-line" points="192,145 192,207 433,266" />
    <!-- FM 1 line (~9:30 position) -->
    <polyline class="leader-line" points="284,145 284,197 421,230" />
    <!-- FM 2 line (~10:30 position) -->
    <polyline class="leader-line" points="375,145 375,175 429,188" />
    <!-- AUX line (drop vertically from T-bar) -->
    <line class="leader-line" x1="456" y1="145" x2="476" y2="145" />
    <polyline class="leader-line" points="466,145 466,170" />
    <!-- PA line (~2 o'clock) -->
    <polyline class="leader-line" points="520,188 510,188 493,205" />
    <!-- COM 1 Bottom line (~7 o'clock) -->
    <polyline class="leader-line" points="432,295 432,290 455,267" />
  </svg>

  <div class="component" style="left:395px; top:287px; pointer-events:none;">
    <span class="label" style="margin:0; color:#999;">COM 1</span>
  </div>

  <div class="component" style="left:530px; top:180px; pointer-events:none;">
    <span class="label" style="margin:0; color:#999;">PA</span>
  </div>
  ...
  <div class="component toggle red" id="iso_emr" data-active="false" style="left:80px; bottom:50px;">
    <div class="assembly-toggle"><div class="nut"></div></div>
    <span class="label label-bottom">ISO/EMR</span>
  </div>

  <div class="component" style="left:170px; bottom:55px;">
  ...
  <div class="component" id="vox_wrap" style="left:270px; bottom:45px;">
    ...
    <div class="knob-vol small" id="vox" data-value="50"><div class="vol-pointer" id="ptr_vox"></div></div>
  </div>
...
(function() {
  ...
  const panelState = {
    ...
    ics_mic: true,
    ics_call: false,
    selector: { position: 'COM1', angle: -130, index: 0 },
    rxvol: 50,
    vox: 50,
    icsvol: 50,
    tx_light: true
